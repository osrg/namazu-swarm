...
def _run(args: argparse.Namespace) -> None:
    ...
    ui = _ui(args.ui)
    run(driver, scheduler, storage, ui, args.parallel, image)
...
def _create_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        '--db',
        type=str,
        help='DB connection string ' + '(e.g. "sqlite:///nmzswarm.sqlite3")')
    ...
    parser_run.add_argument(
        'image', nargs='+', help='Image that contains NamazuSwarmfile')
